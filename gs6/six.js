...
lib.ssMetadata = [
		{name:"six_atlas_1", frames: [[0,0,1024,683],[1026,0,400,347]]}
];
...
(lib.Behind = function() {
	this.initialize(ss["six_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#E5B672").s().p("EhK/AvfMAAAhe9MCV/AAAMAAABe9g");
...
}).prototype = getMCSymbolPrototype(lib.Cursor_1, new cjs.Rectangle(-88,-77,171.9,144.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-112,16,0.9015,0.7997);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Behind_1, new cjs.Rectangle(-112,16,923.2,546.2), null);
...
}).prototype = getMCSymbolPrototype(lib._2, new cjs.Rectangle(-160,-133,171.9,144.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(626.15,241.35,1.2307,0.9621,0,0,0,401.6,266.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(-5.9,0,1136.1000000000001,525.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.cache(-8,-2,1140,530);
...
p.nominalBounds = new cjs.Rectangle(474.9,258.5,488.6,326.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/six_atlas_1.png", id:"six_atlas_1"}
	],
	preloads: []
};
